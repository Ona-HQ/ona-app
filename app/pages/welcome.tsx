...
const Welcome: NextPage = () => {
  ...
  const browsePlatform = async () => {
    localStorage.setItem('ona-skip-welcome', true);
    router.push('/');
  };
        ...
        <div className="relative px-4 sm:px-6 lg:px-8">
          <div className="text-lg max-w-prose mx-auto">
            ...
            <p className="mt-8 text-xl text-gray-500 leading-8">
              Ona allows users to create or invest in short-term single trades, typically scalp or swing trades, which take days up to weeks.
            </p>
            <p className="mt-8 text-xl text-gray-500 leading-8">
              ...
              Ona allows you to turn your trade setup into an easily investable vehicle which can be funded by the community in minutes.
            </p>
            <p className="mt-8 text-xl text-gray-500 leading-8">
              Thanks for trying Ona and we hope you have a marvellous time trading and investing!
            </p>
            <p className="mt-8 text-xl text-gray-500 leading-8 text-center">
              <button onClick={() => setShowCreateAccountModal(true) } className="inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md text-indigo-700 bg-indigo-100 hover:bg-indigo-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                Create a Ona Account
              </button>
              <a href="https://docs.ona.so" target="_blank" className="ml-4 inline-flex items-center px-3 py-2 border border-gray-300 shadow-sm text-sm leading-4 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                Read the docs
              </a>
            </p>
