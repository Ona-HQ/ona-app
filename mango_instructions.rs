...
pub enum MangoInstruction {
    ...
    /// 2. `[signer]` owner_ai - Solana account of owner of the mango account
    /// 3. `[]` system_prog_ai - System program
    /// 4. `[signer, writable]` payer_ai - pays for the PDA creationÏ
    CreateMangoAccount {
        account_num: u64,
    },
    ...
    pub fn unpack(input: &[u8]) -> Option<Self> {
        ...
        Some(match discrim {
            ...
            5 => {
                ...
                MangoInstruction::AddToBasket { market_index: i64::from_le_bytes(*market_index) }
            }
            6 => {
                let quantity = array_ref![data, 0, 8];
            ...
            15 => {
                ...
                MangoInstruction::ConsumeEvents { limit: i64::from_le_bytes(*data_arr) }
            }
            ...
            22 => {
                ...
                MangoInstruction::SettlePnl { market_index: i64::from_le_bytes(*data_arr) }
            }
            23 => {
                ...
                MangoInstruction::SettleBorrow {
                    token_index: i64::from_le_bytes(*token_index),
            ...
            27 => {
                ...
                MangoInstruction::LiquidateTokenAndPerp {
                    ...
                    asset_index: i64::from_le_bytes(*asset_index),
                    liab_type: AssetType::try_from(u8::from_le_bytes(*liab_type)).unwrap(),
                    liab_index: i64::from_le_bytes(*liab_index),
            ...
            67 => {
                ...
                MangoInstruction::SetMarketMode {
                    market_index: i64::from_le_bytes(*market_index),
...
pub fn place_spot_order(
    ...
    market_index: i64, // used to determine which of the open orders accounts should be passed in write
    order: serum_dex::instruction::NewOrderInstructionV3,
) -> Result<Instruction, ProgramError> {
    let mut accounts = vec![
        AccountMeta::new_readonly(*mango_group_pk, false),
...
pub fn place_spot_order2(
    ...
    affected_market_open_orders_index: i64, // used to determine which of the open orders accounts should be passed in write
    order: serum_dex::instruction::NewOrderInstructionV3,
) -> Result<Instruction, ProgramError> {
    let mut accounts = vec![
        AccountMeta::new_readonly(*mango_group_pk, false),
